...
//电池电量(只上报)
//备注:
#define DPID_BATTERY_PERCENTAGE 103
//温度报警(只上报)
//备注:
#define DPID_TEMP_ALARM 104
//湿度报警(只上报)
//备注:
#define DPID_HUM_ALARM 105
//人体感应(只上报)
//备注:
#define DPID_PIR_STATE 106
//当前亮度(只上报)
//备注:
#define DPID_BRIGHT_VALUE 107
//co2(只上报)
//备注:
#define DPID_CO2_VALUE 108
//co(只上报)
//备注:
#define DPID_CO_VALUE 109
//pm2.5(只上报)
//备注:
#define DPID_PM25_VALUE 110
//voc(只上报)
//备注:
#define DPID_VOC_VALUE 111
//ch4(只上报)
//备注:
#define DPID_CH4_VALUE 112
//gas(只上报)
//备注:
#define DPID_GAS_SENSOR_VALUE 113
//smoke(只上报)
//备注:
#define DPID_SMOKE_VALUE 114
//pressure(只上报)
//备注:
#define DPID_PRESSURE_VALUE 115
//按键1(可下发可上报)
//备注:
#define DPID_SW_01 116
//按键2(可下发可上报)
//备注:
#define DPID_SW_02 117
//按键3(可下发可上报)
//备注:
#define DPID_SW_03 118
//按键4(可下发可上报)
//备注:
#define DPID_SW_04 119
//cur_current(只上报)
//备注:
#define DPID_CUR_CURRENT 120
//cur_power(只上报)
//备注:
#define DPID_CUR_POWER 121
//cur_voltage(只上报)
//备注:
#define DPID_CUR_VOLTAGE 122
//add_ele(只上报)
//备注:：0-50000, 间距：100, 倍数：3, 单位：kwh
#define DPID_ADD_ELE 123
//红外学习(可下发可上报)
//备注:
#define DPID_SW_05 124
//点亮屏幕(可下发可上报)
//备注:
#define DPID_SW_06 125
//sw(可下发可上报)
//备注:
#define DPID_SW_07 126
//sw(可下发可上报)
//备注:
#define DPID_SW_08 127
//bright_value_rgb(可下发可上报)
//备注:
#define DPID_BRIGHT_VALUE_RGB 128
//temp_value_rgb(可下发可上报)
//备注:
#define DPID_TEMP_VALUE_RGB 129
//clour_data(可下发可上报)
//备注:类型：字符； Value: 000011112222； 0000：H（色度：0-360，0X0000-0X0168）； 1111：S (饱和：0-1000, 0X0000-0X03E8）； 2222：V (明度：0-1000，0X0000-0X03E8)
#define DPID_CLOUR_DATA 130
//rsv(可下发可上报)
//备注:
#define DPID_RSV_01 131
//rsv(可下发可上报)
//备注:
#define DPID_RSV_02 132
//rsv(可下发可上报)
//备注:
#define DPID_RSV_03 133
//rsv(可下发可上报)
//备注:
#define DPID_RSV_04 134
//温度设定(可下发可上报)
//备注:
#define DPID_TEMP_SETTING 135
//湿度设定(可下发可上报)
//备注:
#define DPID_HUM_SETTING 136
//红外控制下发(可下发可上报)
//备注:
#define DPID_IR_SEND 201
//红外学习值上报(只上报)
//备注:
#define DPID_IR_STUDY_CODE 202
